...
const activityChartData = computed(() => {
  ...
  return Array.isArray(activityData.value) ? activityData.value : [activityData.value]
})
...
<template>
  <div class="dashboard-container">
    ...
    <div class="flex items-center justify-between mb-6">
      ...
      <Button variant="ghost" size="icon" :loading="isLoading" @click="handleRefresh">
        <template #icon-left>
          <RefreshIcon :size="16" />
        </template>
      </Button>
    ...
    <div class="charts-row mb-8">
      ...
      <div class="chart-card">
        <AdminPieChart :data="itemDistributionData" :loading="isLoadingStats" />
      </div>
    </div>
    ...
    <div class="charts-row mb-8">
      ...
      <div class="chart-card">
        <AdminHeatmapChart :data="heatmapData" :loading="isLoadingActivity" />
      </div>

      <!-- Top Users Leaderboard -->
      <div class="chart-card">
        <AdminLeaderboardChart :data="leaderboardData" :loading="isLoadingStats" />
      </div>
    </div>
