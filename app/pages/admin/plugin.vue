...
async function handleSaveSetting(payload: { key: string; value: string | number | boolean | Record<string, unknown> | unknown[] }) {
  isSaving.value = true
  try {
...
function handleReset() {
  dialog.warning({
    ...
    content: 'Are you sure you want to reset all plugin settings to their default values? This action cannot be undone.',
    ...
    <div class="page-header">
      <div class="flex items-center gap-3">
        ...
        <div>
          ...
          <p class="text-sm text-gray-400">Manage CS2 plugin settings from the web panel</p>
        </div>
      </div>
