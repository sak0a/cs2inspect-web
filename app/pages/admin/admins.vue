    ...
    <div class="admins-page">
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-400">
                        This page is restricted to superadmins. You can manage who has
        ...
        <div v-if="!isSuperAdmin" class="access-denied">
            ...
            <p class="text-gray-400">
                You do not have permission to access this page. Only superadmins can manage
                administrators.
            </p>
                ...
                <div v-for="admin in adminUsers" :key="admin.id" class="admin-card">
                    <div class="flex items-center gap-4">
                        ...
                        <div
                            class="avatar"
                            :class="
                                admin.role === 'superadmin' ? 'avatar--superadmin' : 'avatar--admin'
                            "
                        >
                            <NIcon :component="ShieldIcon" :size="24" />
                        </div>
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <div
                                v-if="admin.permissions.length > 0"
