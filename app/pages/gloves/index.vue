...
const handleGloveTypeChange = async (team: 't' | 'ct', gloveDefindex: number) => {
    ...
    await $fetch(
        ...
        .then(async () => {
            ...
            if (team === 't') {
                loadoutStore.selectedLoadout.selected_glove_t =
                    gloveDefindex === -1 ? null : gloveDefindex
            } else {
                loadoutStore.selectedLoadout.selected_glove_ct =
                    gloveDefindex === -1 ? null : gloveDefindex
            }
                ...
                <template v-else>
                    ...
                    >
                        <GloveTabs
                            ...
                            @weapon-click="
                                (glove: GloveItemData) =>
                                    handleGloveClick(glove as unknown as IEnhancedGlove)
                            "
                        />
                    </TransitionGroup>
                    <!-- No Skins State -->
