        ...
        const data = await $fetch<{ inspectUrl: string; message?: string }>(
            `/api/inspect?action=create-url&steamId=${user.value?.steamId || ''}`,
            {
                ...
                body: {
                    ...
                    stattrak_count:
                        parsedData.killeatervalue ||
                        parsedData.stattrak_count ||
                        parsedData.statTrakCount,
                    nametag: parsedData.customname || parsedData.nametag || parsedData.nameTag,
                    stickers: parsedData.stickers,
                    keychain:
                        (parsedData.keychains && parsedData.keychains[0]) || parsedData.keychain,
...
<template>
    <div class="min-h-screen py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto">
            ...
            <!-- Main Card -->
            <div
                class="rounded-3xl overflow-hidden border border-white/5 shadow-2xl relative group"
            >
