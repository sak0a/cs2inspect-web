        ...
        if (config.stickers && Array.isArray(config.stickers)) {
            for (let index = 0; index < Math.min(config.stickers.length, 5); index++) {
                ...
                stickerPromises.push(
                    $fetch<{ success: boolean; data: APISticker[] }>(
                        `/api/data/stickers?id=sticker-${id}`
                    )
                        .then((response) => {
...
const handleDuplicate = async () => {
    ...
    try {
        ...
        const errorMessage =
            error instanceof Error
                ? error.message
                : (t('modals.weaponSkin.duplicateFailed') as string)
        state.value.error = errorMessage
        message.error(errorMessage)
        emit('error', errorMessage)
            ...
            <NSpace vertical size="large" class="-mt-2">
                <Transition name="fade" mode="out-in">
                    ...
                    <div v-else key="normal">
                        ...
                        <div
                            v-if="selectedSkin"
                            class="bg-[var(--bg-secondary)] p-6 rounded-lg bg-opacity-50"
                        >
                                ...
                                <div>
                                    <div class="relative">
                                        ...
                                        <button
                                            ...
                                            :title="
                                                (t(
                                                    'modals.weaponSkin.visualCustomizer.button'
                                                ) as string) || 'Visual Customizer'
                                            "
                                            :aria-label="
                                                (t(
                                                    'modals.weaponSkin.visualCustomizer.button'
                                            ...
                                            "
                                            @click.stop="
                                                weaponState.inlineVisualCustomizerActive = true
                                            "
                                        >
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <!-- Skin Name Overlay -->
                                        <h3
                                            class="absolute bottom-0 left-0 right-0 text-lg font-bold px-2 py-1"
                                        >
                                            {{ selectedSkin?.name }}
                                        </h3>
                                    </div>
                                ...
                                <div class="space-y-4 flex flex-col items-center">
                                    ...
                                    <div class="grid grid-cols-2 gap-4 w-full">
                                        <div class="flex items-center space-x-4">
                                            <NSwitch
                                                v-model:value="customization.stattrak_enabled"
                                            />
                                            <span>{{
                                                t('modals.weaponSkin.labels.stattrak')
                                            }}</span>
                                            <NInputNumber
                                        ...
                                        <NInput
                                            ...
                                            :placeholder="
                                                t(
                                                    'modals.weaponSkin.inputs.nameTagPlaceholder'
                                                ) as string
                                            "
                                            class="pl-1"
                                            maxlength="20"
                                    ...
                                    <div class="flex flex-wrap items-end gap-4 w-full">
                                        <div
                                            ...
                                            data-tutorial="paint-index-override"
                                        >
                                            <div class="flex items-center gap-2">
                                                ...
                                                <NSwitch
                                                    v-model:value="customization.paintIndexOverride"
                                                    size="small"
                                                />
                                            </div>
                                            <NInputNumber
                                        ...
                                        <div
                                            ...
                                            data-tutorial="active-switch"
                                        >
                                            <NSwitch
                                                v-model:value="customization.active"
                                                size="medium"
                                            >
                                                <template #checked>
                                    ...
                                    >
                                        ...
                                        >
                                            <button
                                                ...
                                                :title="
                                                    t('modals.weaponSkin.stickers.remove') as string
                                                "
                                            ...
                                            <div
                                                class="mt-1 absolute top-0 left-1 text-xs text-gray-400"
                                            >
                                                #{{ index + 1 }}
                                            </div>
                                        </div>
                                ...
                                >
                                    ...
                                    >
                                        <button
                                            ...
                                            :aria-label="
                                                String(t('modals.weaponSkin.keychain.remove'))
                                            "
                                            draggable="false"
                                            @mousedown.stop.prevent
                                        ...
                                        >
                                            ...
                                            />
                                            <p
                                                class="text-xs text-center text-gray-400 mt-1 truncate w-full px-1"
                                            >
                                                {{
                                                    (
                                                        customization.keychain.api?.name ?? ''
                        ...
                        >
                            <div class="flex items-center gap-2">
                                <span class="text-sm text-gray-300">{{
                                    t('modals.weaponSkin.sort.label')
                                }}</span>
                                <NSelect
                            ...
                            >
                                ...
                                <NButton
                                    ...
                                    secondary
                                    :type="
                                        rarityFilterIds.includes(rarity.id) ? 'primary' : 'default'
                                    "
                                    :style="
