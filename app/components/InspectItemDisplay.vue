...
const displayName = computed(() => {
    ...
    try {
        ...
        if (props.itemType === 'weapon' || props.itemType === 'knife') {
            if (
                isWeaponConfiguration(props.customization) ||
                isKnifeConfiguration(props.customization)
            ) {
                ...
                <div class="w-full h-48 flex items-center justify-center mb-4">
                    ...
                    >
                        ...
                        <span class="text-gray-400 text-sm">{{
                            t('inspectItem.noImageAvailable')
                        }}</span>
                    </div>
                </div>
                ...
                <div class="w-full">
                    ...
                    <div class="mt-2 grid grid-cols-2 gap-2 text-sm">
                        ...
                        <div>
                            ...
                            <span class="ml-1">{{
                                formatFloat(customization?.paintwear || 0)
                            }}</span>
                        </div>
                        ...
                        <div v-if="itemType === 'weapon' || itemType === 'knife'">
                            ...
                            <span class="ml-1">
                                {{
                                    (customization as WeaponConfiguration | KnifeConfiguration)
                                        ?.stattrak_enabled
                                        ? (
                                              customization as
                                                  | WeaponConfiguration
                    ...
                    <div v-if="itemType === 'weapon' && customization" class="mt-3">
                        ...
                        <div
                            v-if="
                                (customization as WeaponConfiguration)?.stickers?.some(
                                    (s) => s !== null
                                )
                            "
                            class="mb-2"
                        ...
                        <div v-if="(customization as WeaponConfiguration)?.keychain" class="mb-2">
                            ...
                            <div class="flex items-center">
                                ...
                                >
                                    <img
                                        v-if="
                                            (customization as WeaponConfiguration)?.keychain?.api
                                                ?.image
                                        "
                                        :src="
                                            (customization as WeaponConfiguration)?.keychain?.api
