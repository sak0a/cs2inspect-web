                ...
                <template v-if="!isEditing">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <template v-else-if="setting.type === 'json'">
                            <code
                                class="text-xs bg-gray-800 px-2 py-1 rounded text-gray-300 block truncate"
                            >
                                {{ setting.value }}
                            </code>
                        </template>
                        <template v-else>
                            <span class="text-sm text-gray-300 truncate block">{{
                                setting.value
                            }}</span>
                        </template>
                    </div>
                    <NButton size="small" secondary type="primary" @click="startEditing">
                        Edit
                    </NButton>
                </template>
