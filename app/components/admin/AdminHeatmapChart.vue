  ...
  <div class="admin-heatmap-chart">
    ...
    <div class="chart-container glass-container p-4 relative overflow-x-auto">
      ...
      <div v-else-if="hasData" class="heatmap-wrapper">
        ...
        <div class="flex">
          <!-- Day of week labels -->
          <div class="day-labels flex flex-col justify-around pr-2 text-xs text-gray-400" style="height: 98px;">
            <span>Mon</span>
            <span>Wed</span>
            <span>Fri</span>
          </div>
          ...
          <div class="heatmap-grid">
            ...
            >
              <div
                ...
                :style="{ backgroundColor: day ? getCellColor(day.value) : 'transparent' }"
