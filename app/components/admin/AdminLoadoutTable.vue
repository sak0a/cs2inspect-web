...
<template>
        ...
        <template #footer>
            <div class="flex justify-end gap-3">
                ...
                <NButton
                    ...
                    secondary
                    :disabled="
                        formInputs.renameName.length === 0 || formInputs.renameName.length > 25
                    "
    ...
    >
        <div class="space-y-3">
            <p>
                Are you sure you want to delete this loadout? This will remove the loadout and all
                its items.
            </p>
            <p class="font-bold text-red-400">This action cannot be undone.</p>
            <div>
                <p class="mb-2 text-sm text-gray-400">
                    Type <span class="font-mono text-white">{{ selectedLoadout?.name }}</span> to
                    confirm:
                </p>
                <NInput
    ...
    >
        <div class="space-y-3">
            <p class="text-sm text-gray-400">
                Enter a share code to import a loadout for this user.
            </p>
