<template>
    <div class="history-chart">
        ...
        <div class="chart-container glass-container p-4 relative">
            <!-- Chart.js chart -->
            <Line v-if="hasData" :data="chartData" :options="chartOptions" :height="100" />

            <!-- No data message -->
            <div
                v-else
                class="flex items-center justify-center"
                style="color: var(--text-tertiary); min-height: 100px"
            >
        ...
        tooltip: {
            ...
            callbacks: {
                label: (context) => {
                    ...
                    return [`Latency: ${value}ms`, `Status: ${point?.status.toUpperCase()}`]
                },
            },
        },
    },
