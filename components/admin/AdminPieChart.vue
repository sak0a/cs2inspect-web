<template>
  <div class="admin-pie-chart">
    ...
    <div class="chart-container glass-container p-4 relative">
      ...
      <!-- Chart -->
      <div v-else-if="hasData" class="flex flex-col md:flex-row items-center justify-center gap-8">
...
const hasData = computed(() => {
  ...
  const total = props.data.weapons + props.data.knives + props.data.gloves +
                props.data.agents + props.data.musicKits + props.data.pins;
  return total > 0;
});
