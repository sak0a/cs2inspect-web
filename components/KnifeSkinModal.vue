...
import {APISkin, IEnhancedWeapon, KnifeCustomization} from "~/server/utils/interfaces"
...
const emit = defineEmits<{
  ...
  (e: 'select', skin: IEnhancedWeapon, customization: KnifeCustomization): void
}>()
...
const handleSave = () => {
  ...
  console.log('KSM Save - selectedSkin', selectedSkin.value)
  console.log('KSM Save - customization', customization.value)
  ...
  if (props.visible && props.weapon) {
    ...
    if (dbInfo) {
      customization.value = {
        ...
        defindex: Number(dbInfo.defindex) | 0,
        ...
        <div class="grid grid-cols-2 gap-6">
          ...
          <div class="space-y-6 flex flex-col items-center">
            ...
            <div class="flex items-center justify-center w-full mt-0 gap-2">
              <NButton type="success" secondary class="w-96" @click="handleSave">
                Save Changes
              </NButton>
