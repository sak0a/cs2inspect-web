...
const categories: Category[] = [
  ...
  },
  {
    ...
    emoji: '\u{1F4E6}',
    label: 'Deploy',
    description: 'Production & dev branch deployment',
    commands: [
      {
        id: 'deploy:app',
        label: 'Deploy to production',
        hint: 'Force-pushes master \u2192 app branch (strips services/ and large assets)',
        run: './scripts/deploy-app.sh',
        dangerous: true,
        dangerMessage: 'force-push master to the production app branch',
      },
      {
        id: 'deploy:app-dev',
        label: 'Deploy to dev',
        hint: 'Force-pushes master \u2192 app-dev branch (auto-stashes local changes)',
        run: './scripts/deploy-app-dev.sh',
        dangerous: true,
        dangerMessage: 'force-push master to the app-dev branch',
      },
    ],
  },
  {
