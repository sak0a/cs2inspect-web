...
describe('validateRequiredRequestData', () => {
    it('should throw error for missing param', () => {
        expect(() => validateRequiredRequestData(null, 'Test Param')).toThrow('Test Param is required');
    });

    it('should throw error for empty string', () => {
        expect(() => validateRequiredRequestData('', 'Test Param')).toThrow('Test Param is required');
    });
