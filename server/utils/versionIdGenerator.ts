...
const adjectives = [
  'blue', 'red', 'gold', 'dark', 'wild', 'fast', 'cool', 'bold',
  'calm', 'deep', 'epic', 'fair', 'gray', 'keen', 'loud', 'mild',
  'neon', 'pale', 'pure', 'rare', 'rich', 'soft', 'tall', 'warm',
  'wise', 'aged', 'big', 'dry', 'fit', 'hot', 'icy', 'new',
  'old', 'raw', 'shy', 'sly', 'wet', 'odd', 'zen', 'dim',
  'slim', 'grim', 'iron', 'jade', 'onyx', 'ruby', 'silk', 'void'
]

// Short nouns (3-5 chars)
const nouns = [
  'fox', 'owl', 'bear', 'wolf', 'hawk', 'lion', 'deer', 'crow',
  'dove', 'frog', 'goat', 'hare', 'kite', 'lynx', 'moth', 'newt',
  'pike', 'seal', 'swan', 'toad', 'wasp', 'wren', 'ape', 'bat',
  'bee', 'cat', 'cod', 'dog', 'eel', 'elk', 'fly', 'gnu',
  'ant', 'ram', 'ray', 'yak', 'orb', 'arc', 'gem', 'sun',
  'moon', 'star', 'wind', 'fire', 'ice', 'rock', 'wave', 'leaf'
]
