import { mysqlTable, int, varchar, tinyint, timestamp, index, uniqueIndex } from 'drizzle-orm/mysql-core';
import { loadouts } from './loadouts';

export const agents = mysqlTable('wp_player_agents', {
    ...
    uniqueIndex('uq_wp_player_agents_unique').on(table.steamid, table.loadoutid, table.team, table.defindex),
]));
