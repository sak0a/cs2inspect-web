...
export default defineEventHandler(async (event) => {
    ...
    try {
        switch (action) {
            case 'create-url': {
                // Create an inspect URL from item data
                ...
                const inspectUrl = client.createInspectUrl(itemData);

                Logger.success(`Created inspect URL for weapon ${itemData.defindex}`)
                return {
                    success: true,
                    inspectUrl,
                    itemData
            ...
            case 'inspect-item': {
                ...
                // Use optimized static method to analyze URL (no instance creation)
