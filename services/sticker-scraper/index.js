    ...
    5124, 5125, 5126, 5127, 5128, 5371, 5372, 5373, 5374, 5375, 5376, 5377, 5378, 5379, 5380, 5381,
    5382, 5383, 5384, 5385, 5386, 5387, 5388, 5389, 5390, 5391, 5392, 5393, 5394, 5395, 6061, 6062,
    6063, 6064, 6065, 6066, 6067, 6068, 6069, 6070, 6071, 6072, 6073, 6074, 6075, 6076, 6077, 6078,
    6079, 6080, 6081, 6082, 6083, 6084, 6085, 6708, 6709, 6710, 6711, 6712, 6713, 6714, 6715, 6716,
    ...
    7370, 7371, 7372, 7373, 7374, 7375, 7376, 7377, 7378, 7908, 7920, 8028, 8029, 8030, 8031, 8032,
    8033, 8034, 8035, 8036, 8037, 8038, 8039, 8040, 8041, 8042, 8043, 8044, 8045, 8046, 8047, 8048,
    8049, 8050, 8051, 8052, 8686, 8687, 8688, 8689, 8690, 8691, 8692, 8693, 8694, 8695, 8696, 8697,
    8698, 8699, 8700, 8701, 8702, 8703, 8704, 8705, 8706, 8707, 8708, 8709, 8710, 8711, 8712, 8713,
    8714, 8715, 8716, 8717, 8718, 9621, 9622, 9623, 9624, 9625, 9626, 9627, 9628, 9629, 9630, 9631,
...
async function downloadAndProcessImage(stickerId, wear) {
    try {
        ...
        let sharpInstance = sharp(response.data).resize(TARGET_WIDTH, TARGET_HEIGHT, {
            fit: 'contain',
...
async function scrapeStickers() {
    ...
    console.log(
        `WebP Optimization: ${OPTIMIZE_WEBP ? `Yes (Quality: ${WEBP_QUALITY})` : 'No (Lossless)'}`
    )
    console.log(
        `Total images to check: ${(MAX_STICKER_ID - MIN_STICKER_ID + 1) * WEAR_VALUES.length}`
    )
    console.log('='.repeat(60))
    ...
    for (let stickerId = startId; stickerId <= MAX_STICKER_ID; stickerId++) {
        ...
        const downloadTasks = WEAR_VALUES.map((wear) => downloadAndProcessImage(stickerId, wear))
        ...
        if (stickerId % 50 === 0 || stickerDownloaded > 0) {
            ...
            const percent = (
                ((stickerId - MIN_STICKER_ID + 1) / (MAX_STICKER_ID - MIN_STICKER_ID + 1)) *
                100
            ).toFixed(1)
            const stickerSizeStr =
                stickerBytes > 0 ? ` | Sticker: ${formatBytes(stickerBytes)}` : ''
            console.log(
        ...
        if (stickersInLast100 >= 100) {
            console.log(
                `📊 Last 100 stickers: ${formatBytes(last100Bytes)} | Session total: ${formatBytes(totalBytesDownloaded)}`
            )
            last100Bytes = 0
            stickersInLast100 = 0
        }
