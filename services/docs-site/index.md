...
features:
  ...
  - title: Multi-Loadout System
    details: Create unlimited loadout configurations and switch between them instantly. Perfect for different playstyles and themes.
  - title: Advanced Visual Customizer
    details: Canvas-based sticker positioning with drag-and-drop, rotation, and scaling for precise customization.
  - title: Inspect URL Processing
