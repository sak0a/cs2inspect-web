            ...
            try {
                ...
                return {
                    ...
                    error: {
                        ...
                        message:
                            error instanceof Error ? error.message : 'Failed to create inspect URL',
                    },
                }
            }
        }
            ...
            try {
                ...
                return {
                    ...
                    error: {
                        code: 'DECODE_ERROR',
                        message:
                            error instanceof Error ? error.message : 'Failed to decode masked URL',
                    },
                }
            }
        }
            ...
            try {
                ...
                return {
                    ...
                    error: {
                        code: 'DECODE_ERROR',
                        message:
                            error instanceof Error ? error.message : 'Failed to decode hex data',
                    },
                }
            }
        }
