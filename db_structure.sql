create table cs2inspect_dev.wp_player_loadouts
(
    ...
    selected_agent_ct smallint unsigned                     null comment 'DEFINDEX for Agent of CT',
    selected_music    smallint unsigned                     null comment 'ID of selected music kit',
    selected_agent_t  smallint unsigned                     null comment 'DEFINDEX for Agent of T',
    created_at        timestamp default current_timestamp() not null,
    updated_at        timestamp default current_timestamp() not null on update current_timestamp()
)
    engine = InnoDB;

create table cs2inspect_dev.wp_player_agents
(
    id         int unsigned auto_increment
        primary key,
    steamid    varchar(64)                            not null,
    ...
    constraint wp_player_agents_ibfk_1
        foreign key (loadoutid) references cs2inspect_dev.wp_player_loadouts (id)
            on delete cascade
)
    engine = InnoDB;

create index idx_steamid_loadout
    on cs2inspect_dev.wp_player_agents (steamid, loadoutid);

create index loadoutid
    on cs2inspect_dev.wp_player_agents (loadoutid);

create table cs2inspect_dev.wp_player_gloves
(
    id         int unsigned auto_increment
        primary key,
    steamid    varchar(64)                            not null,
...
create index idx_steamid_loadout
    on cs2inspect_dev.wp_player_gloves (steamid, loadoutid);

create index loadoutid
    on cs2inspect_dev.wp_player_gloves (loadoutid);

create table cs2inspect_dev.wp_player_heavys
(
    id               int unsigned auto_increment
        primary key,
    steamid          varchar(64)                              not null,
...
create index idx_steamid_loadout
    on cs2inspect_dev.wp_player_heavys (steamid, loadoutid);

create index loadoutid
    on cs2inspect_dev.wp_player_heavys (loadoutid);

create table cs2inspect_dev.wp_player_knifes
(
    id               int unsigned auto_increment
        primary key,
    steamid          varchar(64)                              not null,
...
create index idx_steamid_loadout
    on cs2inspect_dev.wp_player_knifes (steamid, loadoutid);

create index loadoutid
    on cs2inspect_dev.wp_player_knifes (loadoutid);

create index idx_steamid
    on cs2inspect_dev.wp_player_loadouts (steamid);

create table cs2inspect_dev.wp_player_music
(
    id         int unsigned auto_increment
        primary key,
    steamid    varchar(64)                            not null,
...
create index idx_steamid_loadout
    on cs2inspect_dev.wp_player_music (steamid, loadoutid);

create index loadoutid
    on cs2inspect_dev.wp_player_music (loadoutid);

create table cs2inspect_dev.wp_player_pins
(
    id         int unsigned auto_increment
        primary key,
    steamid    varchar(64)                            not null,
...
create index idx_steamid_loadout
    on cs2inspect_dev.wp_player_pins (steamid, loadoutid);

create index loadoutid
    on cs2inspect_dev.wp_player_pins (loadoutid);

create table cs2inspect_dev.wp_player_pistols
(
    id               int unsigned auto_increment
        primary key,
    steamid          varchar(64)                              not null,
...
create index idx_steamid_loadout
    on cs2inspect_dev.wp_player_pistols (steamid, loadoutid);

create index loadoutid
    on cs2inspect_dev.wp_player_pistols (loadoutid);

create table cs2inspect_dev.wp_player_rifles
(
    id               int unsigned auto_increment
        primary key,
    steamid          varchar(64)                              not null,
...
create index idx_steamid_loadout
    on cs2inspect_dev.wp_player_rifles (steamid, loadoutid);

create index loadoutid
    on cs2inspect_dev.wp_player_rifles (loadoutid);

create table cs2inspect_dev.wp_player_smgs
(
    id               int unsigned auto_increment
        primary key,
    steamid          varchar(64)                              not null,
...
create index idx_steamid_loadout
    on cs2inspect_dev.wp_player_smgs (steamid, loadoutid);

create index loadoutid
    on cs2inspect_dev.wp_player_smgs (loadoutid);
